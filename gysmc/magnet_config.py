...
class MagnetConfig(ABC):
    ...
    def test_gij2D(self, tor1_arr=None, tor2_arr=None, tor3_arr=0.0):
        ...
        for i in range(0, len(tor2_arr) - 1, len(tor2_arr) // npolshow):
            plt.plot(
                tor1_arr, CovariantMetricTensor[:, i, 0, 0, 0], label=r"get_gij, $\theta={:.2f}$".format(tor2_arr[i])
            )
        ...
        for i in range(0, len(tor2_arr) - 1, len(tor2_arr) // npolshow):
            plt.plot(
                tor1_arr,
                CovariantMetricTensor[:, i, 0, 0, 1] / tor1_arr,
                label=r"get_gij, $\theta={:.2f}$".format(tor2_arr[i]),
            )
        ...
        for i in range(0, len(tor2_arr) - 1, len(tor2_arr) // npolshow):
            plt.plot(
                tor1_arr,
                CovariantMetricTensor[:, i, 0, 1, 1] / tor1_arr**2,
                label=r"get_gij, $\theta={:.2f}$".format(tor2_arr[i]),
            )
