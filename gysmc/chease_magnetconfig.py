...
class CHEASEMagnetConfig(GSEMagnetConfig):
    ...
    def __init__(self, ogyropsi_filename, psinorm_max=0.95, rmax=1.0, positive_current=False, verbose=True):
        """
        ...
        super().__init__(cocos=self.cocos, positive_current=positive_current, verbose=verbose)
        ...
        self.psi1_real = self.ogyropsi_data['PSI'][-1]
        ...
        self.p_cb = CubicSpline(self.r_grid, p_norm, bc_type=((1,0), (2,0)))
